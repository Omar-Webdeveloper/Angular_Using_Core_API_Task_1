...
- Create Angular project with ng: `ng new angular_using_core_api.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`angular_using_core_api.client.esproj`).
